  ...
  return [
    {
      ...
      async configureServer(server) {
        ...
        if (options.api && options.watch)
          (await import('./chunk-api-setup.62497239.js')).setup(ctx);
        if (!options.watch)
